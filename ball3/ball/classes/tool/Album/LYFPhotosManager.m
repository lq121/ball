...
+ (void)showPhotosManager:(UIViewController *)viewController withMaxImageCount:(NSInteger)maxCount andLastChoseImageCount:(NSInteger)choseCount withAlbumArray:(void (^)(NSMutableArray<LYFPhotoModel *> *albumArray))albumArray {
    [PHPhotoLibrary requestAuthorization:^(PHAuthorizationStatus status) {
        dispatch_async(dispatch_get_main_queue(), ^{
                    ...
                    albumArray([LYFPhotoManger standardPhotoManger].photoModelList);
                               ...
                               [LYFPhotoManger standardPhotoManger].choiceCount = choseCount;
                               [LYFPhotoManger standardPhotoManger].lastChoiceCount = choseCount;
