...
@interface RBJinXuanHuaTiTabVC ()
@property (nonatomic, strong) NSMutableArray *dataArr;
@property (nonatomic, assign) int currentPage;
@end

@implementation RBJinXuanHuaTiTabVC
...
- (void)loadData {
    ...
    [RBNetworkTool PostDataWithUrlStr:@"try/go/gethuatibyjing" andParam:dict Success:^(NSDictionary *_Nonnull backData) {
