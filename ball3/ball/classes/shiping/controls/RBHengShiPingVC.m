...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    if (indexPath.row == 0) {
        ...
        RBCommButton *topicBtn = [[RBCommButton alloc] initWithImage:@"btn／replay" andHeighImage:@"btn／replay" andFrame:CGRectMake((RBScreenWidth - 60) * 0.5, RBStatusBarH + 63, 60, 67) andTitle:@"重新播放" andTarget:self andAction:@selector(showVideoPlayer:) andLabelFontSize:14];
        topicBtn.hidden = YES;
